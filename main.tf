locals {
  ...
  # dbt_git_repo            = "https://github.com/karolstepanienko/tbd-tpc-di.git"
...
module "data-pipelines" {
  ...
  data_service_account = google_service_account.tbd-composer-sa.email
  dag_bucket_name      = local.data_bucket_name
