...
| <a name="input_dataproc_master_machine_type"></a> [dataproc\_master\_machine\_type](#input\_dataproc\_master\_machine\_type) | Machine type to use for master nodes in Dataproc cluster | `string` | `"e2-standard-4"` | no |
...
| <a name="input_dataproc_worker_machine_type"></a> [dataproc\_worker\_machine\_type](#input\_dataproc\_worker\_machine\_type) | Machine type to use for worker nodes in Dataproc cluster | `string` | `"e2-standard-4"` | no |
